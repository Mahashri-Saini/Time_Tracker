...
navigate("/");
  ...
  return (
    ...
    <button onClick={backHandler} className='bg-[#801336] mx-2 rounded-full hover:bg-[#2D142C]  p-4 py-2 text-sm font-bold text-white'>BACK</button>
       <div className="mx-3 md:container md:mx-auto my-5 rounded-xl p-5 bg-[#C72C41] min-h-[80vh] md:w-[70%]">
        ...
        <h1 className='font-bold text-center text-3xl'>Set Targets for TODAY</h1>
         <div className="addTodo my-5 flex flex-col gap-4">
          ...
          <input  onChange={handleChangeFrom} value={todoFrom} type="time" className='w-[20%] rounded-full px-5 py-1 bg-gradient-to-r from-[#FF847C] to-[#FECEA8]' />
          <input  onChange={handleChangeTo} value={todoTo} type="time" className='w-[20%] rounded-full px-5 py-1 bg-gradient-to-r from-[#FF847C] to-[#FECEA8]' />
